...
struct Tukey {
  ...
  inline static double SquareRootWeight(double dErrorSquared,
                                        double dSigmaSquared);
  inline static double Weight(double dErrorSquared, double dSigmaSquared);
  inline static double ObjectiveScore(double dErrorSquared,
                                      double dSigmaSquared);
};
...
inline double Tukey::SquareRootWeight(double dErrorSquared,
                                      double dSigmaSquared) {
...
inline double Tukey::ObjectiveScore(double dErrorSquared,
...
inline double Cauchy::SquareRootWeight(double dErrorSquared,
                                       double dSigmaSquared) {
  return sqrt(Weight(dErrorSquared, dSigmaSquared));
}

inline double Cauchy::ObjectiveScore(double dErrorSquared,
                                     const double dSigmaSquared) {
...
inline double Huber::SquareRootWeight(double dErrorSquared,
                                      double dSigmaSquared) {
  return sqrt(Weight(dErrorSquared, dSigmaSquared));
}

inline double Huber::ObjectiveScore(double dErrorSquared,
                                    const double dSigmaSquared) {
  if (dErrorSquared < dSigmaSquared)
...
inline double LeastSquares::SquareRootWeight(double dErrorSquared,
                                             double dSigmaSquared) {
  return 1.0;
}

inline double LeastSquares::ObjectiveScore(double dErrorSquared,
                                           const double dSigmaSquared) {
  return dErrorSquared;
}

inline double LeastSquares::FindSigmaSquared(

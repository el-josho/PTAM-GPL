...
struct TrackerData {
  ...
  // Sometimes in tracker instead of reprojecting, just update the error
  // linearly!
  inline void LinearUpdate(const Vector<6>& v6) { v2Image += m26Jacobian * v6; }

  // This static member is filled in by the tracker and allows in-image checks
  // in this class above.

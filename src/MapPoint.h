...
struct MapPoint {
  ...
  CVD::ImageRef
      irCenter;  // This is in level-coords in the source pyramid level
  ...
  Vector<3> v3Center_NC;  // Unit vector in Source-KF coords pointing at the
                          // patch center
  Vector<3> v3OneDownFromCenter_NC;  // Unit vector in Source-KF coords pointing
                                     // towards one pixel down of the patch
                                     // center
  Vector<3> v3OneRightFromCenter_NC;  // Unit vector in Source-KF coords
                                      // pointing towards one pixel right of the
                                      // patch center
  Vector<3>
      v3Normal_NC;  // Unit vector in Source-KF coords indicating patch normal

  Vector<3> v3PixelDown_W;     // 3-Vector in World coords corresponding to a
                               // one-pixel move down the source image
  Vector<3> v3PixelRight_W;    // 3-Vector in World coords corresponding to a
                               // one-pixel move right the source image
